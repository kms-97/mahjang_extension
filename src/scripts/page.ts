...
const getPai = () => {
	const hand = window.view.DesktopMgr.Inst.players[0].hand.map(h => h.val);
	const ming = [...window.view.DesktopMgr.Inst.players[0].container_ming.mings];
